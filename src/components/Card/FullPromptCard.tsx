...
export function FullPromptCard({ 
  ...
  const handleCopyClick = async () => {
    try {
      ...
      if (id) {
        api.incrementCopyCount(id).catch(console.error);
      }
      ...
      <div className="fpc-image-wrapper" style={{ aspectRatio }}>
        ...
        {(isAuthenticated || showShare) && (
          <div className="fpc-top-right-actions">
            {isAuthenticated && showReport && (
              <button 
                className="fpc-action-btn fpc-report-btn report-btn" 
            ...
            {showShare && (
              <div style={{ position: 'relative' }}>
                <button 
                  className="fpc-action-btn share-btn" 
                  onClick={(e) => { 
                    e.stopPropagation(); 
            ...
            {isAuthenticated && showEdit && (
              <button 
                className="fpc-action-btn admin-btn" 
            ...
            {isAuthenticated && showDelete && (
              <button 
                className="fpc-action-btn fpc-delete-btn admin-btn" 
